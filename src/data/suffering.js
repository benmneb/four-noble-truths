export const suffering = {
  ...
  tree: [
    ...
    },
    {
      ...
      references: ['SN 56.13', 'SN 22.104', 'SN 22'],
      elaboration:
      ...
      children: [
        ...
        },
        {
          ...
          elaboration:
            'What are volitional formations? There are these six classes of volition: volition regarding sights, sounds, smells, tastes, touches, and thoughts. These are called volitional formations. Volitional formations originate from contact. When contact ceases, volitional formations cease. The practice that leads to the cessation of volitional formations is simply this noble eightfold path.',
          references: ['SN 22.56', 'SN 22.57'],
        },
        {
          id: 'S-10.5',

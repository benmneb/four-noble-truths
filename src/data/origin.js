export const origin = {
  ...
  explanation:
    'This is the noble truth of the origin of suffering: It’s the craving that leads to future rebirth, mixed up with relishing and greed, taking pleasure in various different realms.',
  seeMore: [
    'SN 56.11',
    'SN 12',
    'SN 12.1',
  ...
  children: [
    ...
    },
    {
      ...
      children: [
        {
          id: 'O-3.1',
          text: 'Eye consciousness',
        },
        {
          id: 'O-3.2',
          text: 'Ear consciousness',
        },
        {
          id: 'O-3.3',
          text: 'Nose consciousness',
        },
        {
          id: 'O-3.4',
          text: 'Tongue consciousness',
        },
        {
          id: 'O-3.5',
      ...
      elaborations: [
        {
          reference: 'SN 12.2',
          text: [
            'What is feeling? There are these six classes of feeling. Feeling born of contact through the eye, ear, nose, tongue, body, and mind. This is called feeling.',
          ],
        },
      ],
    },
    ...
    },
    {
      id: 'O-9',
      text: 'Grasping',
      seeMore: ['SN 12.52', 'SN 49.173', 'MN 11'],
      children: [
        {
          id: 'O-9.1',

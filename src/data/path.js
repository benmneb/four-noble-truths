  ...
  children: [
    {
      id: 'P-1',
      text: 'Right View',
      seeMore: ['MN 41', 'SN 12.15', 'SN 45.1', 'AN 9.13'],
      children: [
        {
          id: 'P-1.1',
    ...
    },
    {
      ...
      seeMore: ['SN 45.8', 'MN 19', 'SN 14.12', 'ITI 87', 'ITI 110', 'MN 20'],
      children: [
        {
          id: 'P-2.1',
          text: 'Renunciation',
    ...
    },
    {
      id: 'P-4',
      text: 'Right Action',
      seeMore: ['MN 41', 'AN 8.39', 'AN 8.40', 'AN 10.176'],
      children: [
        {
          id: 'P-4.1',
        ...
        },
        {
          ...
          seeMore: ['AN 8.40', 'SN 1.58', 'AN 7.50'],
          elaborations: [
            {
              text: [
    ...
    },
    {
      ...
      seeMore: ['AN 5.177', 'MN 117'],
      children: [
        {
          id: 'P-5.1',
          text: 'For lay people',
          seeMore: ['AN 4.62', 'AN 5.41', 'AN 8.54'],
          children: [
            {
              id: 'P-5.1.1',
    ...
    },
    {
      id: 'P-6',
      text: 'Right Effort',
      seeMore: ['SN 49.1-12', 'AN 4.14', 'AN 4.69', 'MN 117', 'MN 2', 'DN 33'],
      children: [
        {
          id: 'P-6.1',
          text: 'Restrain unarisen unskillful states of mind',
          seeMore: ['AN 4.69', 'MN 20'],
          elaborations: [
            {
              reference: 'AN 4.14',
              text: [
      ...
      children: [
        {
          ...
          seeMore: ['DN 22', 'MN 119', 'SN 43.1'],
          children: [
            {
              id: 'P-7.1.1',
              text: 'Mindfulness of breathing',
              seeMore: ['MN 119', 'MN 10', 'DN 22', 'MN 62'],
              children: [
                {
                  id: 'P-7.1.1.1',
                  text: 'Mindfulness of long/heavy breaths',
                  seeMore: ['MN 119', 'MN 10', 'DN 22'],
                  elaborations: [
                    {
                      reference: 'MN 118',
                      text: [
                  ...
                  elaborations: [
                    {
                      reference: 'MN 10',
                      text: [
                        'And how does a mendicant meditate observing an aspect of principles with respect to the five grasping aggregates? Such are choices, such is the origin of choices, such is the ending of choices. That’s how a mendicant meditates by observing an aspect of principles with respect to the five grasping aggregates.',
                      ],
                    },
                  ],
                },
            ...
            },
            {
              ...
              children: [
                ...
                },
                {
                  id: 'P-7.4.6.3',
                  text: 'Not-self',
                  seeMore: ['SN 22.99', 'MN 148', 'SN 22.42'],
                  elaborations: [
                    {
                      reference: 'AN 10.60',
                      text: [
